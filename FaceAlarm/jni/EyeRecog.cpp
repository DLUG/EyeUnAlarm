...
extern "C" {
JNIEXPORT void JNICALL Java_org_dlug_android_facealarm_CameraPreview_ObjectRecog(JNIEnv* env, jobject, jint width, jint height, jbyteArray yuv, jintArray bgra, jintArray recogValue)
{
...
//    Mat mgray(height, width, CV_8UC1, (unsigned char *)_yuv);
 ...
 //Start ===============================================
	...
	if(!cascade.load("/data/data/org.dlug.android.facealarm/files/eyes.xml")){
